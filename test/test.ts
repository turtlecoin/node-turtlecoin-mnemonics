...
describe('Test Mnemonics', () => {
    ...
    const expectedMnemonic =
        'sipped nodes dice soprano factual cool ' +
        'wickets bypass vibrate anecdote envy aquarium ' +
        'casket glass mocked jolted biplane adopt ' +
        'candy evolved lively daytime impel irate factual';
    ...
    it('Calculate checksum of words', () => {
        const words = [
            'stunning', 'cool', 'hexagon', 'criminal', 'dabbing', 'dads',
            'magically', 'enjoy', 'ourselves', 'ingesting', 'ongoing', 'southern',
            'green', 'cigar', 'serving', 'pheasants', 'pawnshop', 'mystery',
            'powder', 'sizes', 'randomly', 'melting', 'custom', 'kernels'
        ];
